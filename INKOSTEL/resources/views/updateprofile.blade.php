            ...
            <div class="row no-gutters row-bordered row-border-light">
                ...
                <form action="/update" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control mb-1" name="username" placeholder="isi username anda..." id="usernameInput" oninput="changeButtonColor()" value="{{ $profileData->username }}" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" id="emailInput" class="form-control" placeholder="isi alamat email anda..." name="email" oninput="changeButtonColor()" value="{{ $profileData->email }}" readonly>
                            </div>
